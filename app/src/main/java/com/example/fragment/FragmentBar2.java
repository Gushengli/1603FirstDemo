...
public class FragmentBar2 extends Fragment implements OnPageChangeListener,android.view.View.OnClickListener{
	...
	public View onCreateView(LayoutInflater inflater,
		...
		v = inflater.inflate(R.layout.fragment_informationtwo, null);
		initView();
		setdata();
	...
	private void setdata() {
		...
		listfragment.add(new FragmentFG(URLinterface.URLRX));
		listfragment.add(new FragmentFG(URLinterface.URLFG));
		listfragment.add(new FragmentFG(URLinterface.URLST));
		listfragment.add(new FragmentFG(URLinterface.URLSM));
